...
CREATE TABLE notes (
  ...
  visibility ENUM('privat', 'public', 'geteilt') DEFAULT 'privat',
...
-- Fügen Sie die Spalte visibility zur notes-Tabelle hinzu
-- Wir verwenden ENUM für vordefinierte Statuswerte: 'public', 'private', 'shared'
ALTER TABLE notes ADD COLUMN visibility ENUM('public', 'private', 'shared') NOT NULL DEFAULT 'public';
